...
export const QuestItem1 = () => {
  return (
    <div className="max-h-[78vh] overflow-auto lg:max-w-[500px]">
      <div className="">
        ...
        <div className="h-4" />
        <div className="text-md my-2">stateを定義しよう</div>
        <CopyTextButton dir={"変数名は以下を使用"} text={"[count, setCount]"} />
        <div className="h-4" />
        <div className="text-md my-2">カウントを1ずつ加算する関数を作ろう</div>
        <CopyTextButton dir={"ヒント"} text={"setCount(＋1する処理)"} />
        <div className="h-4" />
        <div className="text-md my-2">index.jsにcomponentファイルをimportしよう</div>
        <CopyTextButton dir={"index.js"} text={`import { Quest1 } from ".././Quest1";`} />
        <div className="h-4" />
        <div className="text-md my-2">Quest1を表示させよう</div>
